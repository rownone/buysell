var DOMAIN_NAME = window.location.hostname.replace('www.', '');
var Configs = {
  domain: DOMAIN_NAME,
  domainid: 32502,
  memberid: 7,
  title: "Welcome to "+DOMAIN_NAME,
  logo: "",
  description: "Join our exclusive community of like minded people on "+DOMAIN_NAME,
  ...
  footer_html: "",
  footer_banner: "",
  domain_affiliate_link: "https://referrals.contrib.com/idevaffiliate.php?id=15959&url=https://www.contrib.com/signup/firststep?domain="+DOMAIN_NAME,
  data_widget_users: {
	success: true,
	data:[
		{
